...
//#region node_modules/.nitro/vite/services/ssr/assets/router-hTD5-uU3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-h1YmRy5N.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Nigerian creative social impact hub empowering vulnerable communities through creativity, vocational training, and sustainable development."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-D-0tQDzh.mjs");
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [
		...
		},
		{
			...
			content: "Empowering vulnerable Nigerian communities through creativity, vocational training, and sustainable development."
		},
		{
			property: "og:type",
			content: "website"
