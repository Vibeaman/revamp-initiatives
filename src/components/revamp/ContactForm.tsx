    ...
    <section id="contact" className="relative overflow-hidden bg-cream py-12 md:py-20">
      ...
      <div className="relative mx-auto max-w-5xl px-6 md:px-10">
        ...
        >
          ...
          <a href="mailto:info@therevampinitiatives.org" className="flex items-center gap-2 rounded-full border border-gold/30 bg-white px-4 py-2 text-sm text-ink shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
            <Mail size={16} className="text-gold" />
            info@therevampinitiatives.org
          </a>
