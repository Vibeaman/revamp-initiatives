      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        ...
        <div className="mb-10 max-w-3xl md:mb-14">
          ...
          <p className="mt-4 max-w-2xl text-sm text-cream/70 md:mt-6 md:text-base">
            Over ₦50,000 in direct cash assistance reaching over 100 women each in 2025, alongside
            sustained empowerment programs from Abuja, Borno, and other parts of Nigeria.
          </p>
        </div>
