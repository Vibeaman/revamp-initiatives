...
export default function Achievements() {
  return (
    <section id="achievements" className="relative overflow-hidden bg-ink py-12 text-cream md:py-20">
      {/* ambient glow */}
      <div className="pointer-events-none absolute -left-40 top-1/3 h-[28rem] w-[28rem] rounded-full bg-gold/10 blur-3xl" />
      <div className="pointer-events-none absolute -right-40 bottom-1/4 h-96 w-96 rounded-full bg-blue/20 blur-3xl" />
          ...
          <motion.div variants={fadeUp}>
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                "100+ women fully empowered with tools & seed capital",
          ...
          >
            {milestoneCards.map((m) => (
              ...
              >
                ...
                <h4 className="mt-2 text-display text-base font-bold text-cream md:text-lg">{m.title}</h4>
                <p className="mt-2 flex-1 text-xs leading-relaxed text-cream/70 md:text-sm">{m.body}</p>
                {m.featured && (
