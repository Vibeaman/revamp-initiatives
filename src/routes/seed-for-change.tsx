...
const entries: DiaryEntry[] = [
  ...
  },
  {
    ...
    folders: DAY_FOLDERS.map((name) => {
      ...
      if (name === "Day 3") {
        return {
          name,
          photos: [
            "https://i.imgur.com/96vYIqL.jpeg",
            "https://i.imgur.com/OpsEvwF.jpeg",
            "https://i.imgur.com/7hYUxGr.jpeg",
            "https://i.imgur.com/rM78iwq.jpeg",
            "https://i.imgur.com/FrfeTIj.jpeg",
            "https://i.imgur.com/AvtsGjB.jpeg",
          ],
        };
      }
      if (name === "Day 4") {
        return {
          name,
          photos: [
            "https://i.imgur.com/FYv1vER.jpeg",
            "https://i.imgur.com/Zn4b5Ds.jpeg",
            "https://i.imgur.com/FkqMbWR.jpeg",
            "https://i.imgur.com/aPZmvdM.jpeg",
            "https://i.imgur.com/2F38qXv.jpeg",
            "https://i.imgur.com/ENhb8M2.jpeg",
          ],
        };
      }
      if (name === "Day 5") {
        return {
          name,
          photos: [
            "https://i.imgur.com/2eC14lW.jpeg",
            "https://i.imgur.com/Ln2bxKJ.jpeg",
            "https://i.imgur.com/qLuTsSn.jpeg",
            "https://i.imgur.com/m64aRfc.jpeg",
          ],
        };
      }
      if (name === "Graduation") {
    ...
    videos: [
      { label: "Highlight", url: "https://player.vimeo.com/video/1217665361" },
...
const stats = [
  { value: "100+", label: "Women trained through our Art Residency program" },
